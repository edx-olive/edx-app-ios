...
extension OEXRouter {
   ...
   @objc func showEnrolledTabBarView() {
    ...
    @objc func pushViewController(controller: UIViewController, fromController: UIViewController) {
