...
protocol IconRenderer : class {
    ...
    func boundsWithAttributes(attributes : [NSAttributedStringKey : Any], inline : Bool) -> CGRect
    func drawWithAttributes(attributes : [NSAttributedStringKey : Any], inContext context : CGContext)
}
...
private class RotatedIconRenderer : IconRenderer {
    ...
    fileprivate func boundsWithAttributes(attributes: [NSAttributedStringKey : Any], inline: Bool) -> CGRect {
...
public enum Icon {
    ...
    private func imageWithStyle(style : OEXTextStyle, sizeOverride : CGFloat? = nil, inline : Bool = false) -> UIImage {
        ...
        attributes[NSAttributedStringKey.font] = Icon.fontWithSize(size: textSize)
        
        let bounds = renderer.boundsWithAttributes(attributes: attributes as [NSAttributedStringKey : Any], inline: inline)
        ...
        renderer.drawWithAttributes(attributes: attributes as [NSAttributedStringKey : Any], inContext: UIGraphicsGetCurrentContext()!)
    ...
    public func attributedTextWithStyle(style : OEXTextStyle, inline : Bool = false) -> NSAttributedString {
        var attributes = style.attributes
        attributes[NSAttributedStringKey.font] = Icon.fontWithSize(size: style.size)
        let bounds = renderer.boundsWithAttributes(attributes: attributes as [NSAttributedStringKey : Any], inline : inline)
